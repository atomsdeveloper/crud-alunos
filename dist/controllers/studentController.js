"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }var _Students = require('../models/Students'); var _Students2 = _interopRequireDefault(_Students);
...
class StudentController {
  ...
  async index(req, res) {
    try {
      const students = await _Students2.default.findAll({
        ...
        order: [
          ...
          [{ model: _Photo2.default, as: "photos" }, "id", "DESC"],
        ],
  ...
  async show(req, res) {
    try {
      ...
      const student = await _Students2.default.findByPk(id, {
        // Order the students by ID in descending order
        // This means the most recently created students will be listed first
        order: [
          ["id", "DESC"],
